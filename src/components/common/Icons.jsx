// Set of small inline stroke icons. Every icon is decorative by default
// (aria-hidden) because it is always paired with visible text in this app;
// components that use an icon *without* adjacent text must add their own
// aria-label on the interactive element instead of relying on the icon.
const base = {
  width: 20,
  height: 20,
  viewBox: '0 0 24 24',
...
export function IconSearchReview(props) {
  return (
    <svg {...base} {...props}>
